...
func SetCurrentOrders(id int, elevator Elevator, currentAllOrders [NumElevs][NumFloors][NumButtons]bool) ([NumFloors][NumButtons]bool, [NumElevs][NumFloors][NumButtons]bool) {
	var btn ButtonType
...
func ClearOrders(id int, elevator Elevator) ([NumFloors][NumButtons]bool, [NumElevs][NumFloors][NumButtons]bool) {
	var b ButtonType
	for b = 0; b < NumButtons; b++ {
		elevator.Lights[id][elevator.Floor][b] = false //id
